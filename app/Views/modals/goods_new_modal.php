<div class="modal fade" id="goodsNewModal" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">New Goods
                </h6>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label fs-14 text-dark">Initial Stock</label>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" data-trigger id="select-eoq" v-model="form.eoq_id" @change="changeEoq($event)">
