                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element align-items-center">
                        ...
                        <div class="btn-list d-lg-none d-block">
                            <a href="<?= base_url('dashboard') ?>" class="btn btn-primary-light">
                                Dashboard
                            </a>
                        </div>
                    ...
                    <nav class="main-menu-container nav nav-pills sub-open">
                        <div class="landing-logo-container">
                            <div class="horizontal-logo">
                                <a href="index.html" class="header-logo">
                                    ...
                                    <img src="<?= base_url() ?>assets/images/brand-logos/smarteoq-logo.png" alt="logo" class="desktop-white">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="d-lg-flex d-none">
                            <div class="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                <a href="<?= base_url('dashboard') ?>" class="btn btn-wave btn-primary">
                                    Go to Dashboard
                                </a>
                            </div>
                        </div>
                ...
                <div class="container text-center">
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-5 customize-image text-center">
                        <div class="text-lg-end">
                            <img src="<?= base_url() ?>assets/images/media/landing/3.png" alt="" class="img-fluid">
                        </div>
                    </div>
                        ...
                        <div class="justify-content-center">
                            <div class="">
                                <div class="feature-logos mt-sm-5 flex-wrap" >
                                    ...
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="<?= base_url() ?>assets/images/media/landing/web/6.png" alt="image" class="featur-icon">
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/15.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/4.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/2.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/10.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/12.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/3.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/16.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/5.jpg" alt="">
                                                    </span>
                                                    <div>
                                    ...
                                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <div class="card custom-card testimonial-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <span class="avatar avatar-md avatar-rounded me-3">
                                                        <img src="<?= base_url() ?>assets/images/faces/7.jpg" alt="">
                                                    </span>
                                                    <div>
            ...
            <section class="section landing-footer text-fixed-white">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="px-4">
                                <p class="fw-semibold mb-3"><a href="index.html"><img src="<?= base_url() ?>assets/images/brand-logos/desktop-dark.png" alt=""></a></p>
